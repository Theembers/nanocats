...
from nanocats.cli import commands
...
def mock_prompt_session():
    ...
    with patch("nanocats.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nanocats.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nanocats.cli.commands.PromptSession") as MockSession, \
         patch("nanocats.cli.commands.FileHistory") as MockHistory, \
