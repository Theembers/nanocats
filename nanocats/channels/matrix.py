...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install nanocats-ai[matrix]"
    ) from e
...
from nanocats.config.paths import get_data_dir, get_media_dir
from nanocats.config.schema import ChannelInstanceConfig
from nanocats.utils.helpers import safe_filename
...
class MatrixConfig(ChannelInstanceConfig):
    type: str = "matrix"
