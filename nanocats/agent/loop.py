...
from nanocats.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from nanocats.agent.tools.message import MessageTool
from nanocats.agent.tools.registry import ToolRegistry
from nanocats.agent.tools.shell import ExecTool
from nanocats.agent.tools.spawn import SpawnTool
...
if TYPE_CHECKING:
    from nanocats.config.schema import AgentConfig, ChannelsConfig, ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nanocats.agent.tools.mcp import connect_mcp_servers
